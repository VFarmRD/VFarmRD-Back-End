...
public interface UserRoleRepository extends JpaRepository<UserRole, Integer> {
    ...
    @Query(value = "select distinct r.role_id from userrole ur left join roles r  on ur.role_id = r.role_id where ur.user_id = :user_id ORDER BY r.role_name ASC limit 1", nativeQuery = true)
