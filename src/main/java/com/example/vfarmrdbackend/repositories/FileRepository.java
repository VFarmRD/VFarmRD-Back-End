...
public interface FileRepository extends JpaRepository<File, Integer> {
    ...
    File getFileByFile_id(@Param("file_id") int file_id);
    ...
    @Query(value = "select * from files f where lower(f.file_name) like lower(:keyword)", nativeQuery = true)
    List<File> findFileWithKeyword(@Param("keyword") String keyword);
}
