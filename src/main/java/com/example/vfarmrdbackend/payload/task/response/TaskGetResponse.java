...
public class TaskGetResponse {
    ...
    public TaskGetResponse(int task_id, String task_name, int manager_user_id, int user_id, String user_name,
            String user_role, int project_id, String project_name, Date created_date, Date start_date,
