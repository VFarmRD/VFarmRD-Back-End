...
public class TaskStatisticsFromDateToDateResponse {
    ...
    public TaskStatisticsFromDateToDateResponse() {
    }

    public TaskStatisticsFromDateToDateResponse(String date, int total_task, int total_task_doing, int total_task_done,
            int total_task_overtime) {
        this.date = date;
