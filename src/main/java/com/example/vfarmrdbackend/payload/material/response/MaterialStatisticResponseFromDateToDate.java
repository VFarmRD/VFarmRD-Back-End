...
public class MaterialStatisticResponseFromDateToDate {
    private String date;
    ...
    public MaterialStatisticResponseFromDateToDate() {
    }

    public MaterialStatisticResponseFromDateToDate(String date, int total_material_used, String most_material_id_used,
